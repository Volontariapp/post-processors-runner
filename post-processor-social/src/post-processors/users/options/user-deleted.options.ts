...
import { POST_PROCESSOR_USER_DELETED_OPTIONS } from '../../options/constants.js';
import { getEventStreamName } from '@volontariapp/messaging';

export const userDeletedOptionsProvider = {
  provide: POST_PROCESSOR_USER_DELETED_OPTIONS,
  useFactory: (customConfig: CustomConfig) => ({
    groupName: 'UserDeletedPostProcessors',
