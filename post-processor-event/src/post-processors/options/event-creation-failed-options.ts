...
import { POST_PROCESSORS_EVENT_CREATION_FAILED_OPTIONS } from './constants.js';
import { Streams } from '@volontariapp/shared';

export const postProcessorsEventCreationFailedOptionsProvider = {
  provide: POST_PROCESSORS_EVENT_CREATION_FAILED_OPTIONS,
