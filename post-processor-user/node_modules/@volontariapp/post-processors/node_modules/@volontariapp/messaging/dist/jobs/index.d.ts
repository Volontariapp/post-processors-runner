...
export declare const JobMessagingType: {
    readonly PUBLISH_POST: PostJobType.PUBLISH_POST;
    readonly PUBLISH_EVENT: EventsJobType.PUBLISH_EVENT;
    readonly FOLLOW_USER: SocialJobType.FOLLOW_USER;
    readonly SEND_WELCOME_EMAIL: UserJobType.SEND_WELCOME_EMAIL;
    readonly RESET_PASSWORD: UserJobType.RESET_PASSWORD;
};
